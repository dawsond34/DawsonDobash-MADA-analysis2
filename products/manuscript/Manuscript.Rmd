...
Figure \@ref(fig:Rplot1) shows a scatterplot for number of Covid-19 deaths and State

```{r Rplot1,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/Rplot1.png")
```

Figure \@ref(fig:Rplot2) shows a scatterplot for number of Covid-19 deaths and Race/Hispanic origin

```{r Rplot2,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/Rplot2.png")
```
